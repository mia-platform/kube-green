...
// +kubebuilder:rbac:groups=kubegreen.kubegreen.com,resources=sleepinfoes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kubegreen.kubegreen.com,resources=sleepinfoes/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=kubegreen.kubegreen.com,resources=sleepinfoes/finalizers,verbs=update
